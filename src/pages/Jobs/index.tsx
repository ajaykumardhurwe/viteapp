...
//                         </span>
//                         <span className="flex items-center space-x-1">
//                           📅 <FaCalendar className="text-green-500" /> Start: <span>{job['Start Date'] || 'Not specified'}</span>
//                         </span>
//                         <span className="flex items-center space-x-1">
//                           ⏳ <FaCalendar className="text-red-500" /> End: <span>{job['End Date'] || 'Not specified'}</span>
//                         </span>
//                       </div>
//                     </div>
//                   </div>
